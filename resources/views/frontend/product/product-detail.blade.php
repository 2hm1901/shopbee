					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img id="zoom" src="{{url('upload/product/hinh200_'.$getArrImage[0])}}" alt="" />
								<a id="link-zoom" href="{{url('upload/product/'.$getArrImage[0])}}" rel="prettyPhoto"><h3>ZOOM</h3></a>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										...
										<div class="item {{$a == 1 ? 'active' : ''}}">
											@for($i = 0; $i < count($getArrImage); $i++)
											<a><img src="{{url('upload/product/hinh50_'.$getArrImage[$i])}}" alt=""></a>
											@endfor
										</div>
										@endfor
									</div>
...
<script>
	$(document).ready(function(){
		...
		$('img').click(function(){
			var changeImage = $(this).attr('src').replace('hinh50_', 'hinh200_');
			$('img#zoom').attr('src', changeImage);
			var zoomImage = changeImage.replace('hinh200_', '');
			$('#link-zoom').attr('href', zoomImage);
		})
