					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li id="cart"><a href="{{url('/cart')}}"><i class="fa fa-shopping-cart"></i> Cart {{session('totalQty.qty')}}</a></li>
								@if(!Auth::check())
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="table-responsive cart_info">
				...
				<button type="submit" class="btn btn-default"><a href="{{url('/mail')}}">Order</a></button>
			</div>
